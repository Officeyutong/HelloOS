...
extern vbe_mode_info_structure* vbe_info;
extern boot_meta_info_struct* boot_meta;
extern FAT32BootSector* boot_sector;
extern GDT* gdt_info;
extern IDT* idt_info;

extern PageDirectory* kernel_page_directory;
extern PageTable* next_kernel_page_table;
extern ASCIIFontTable* ascii_font_table;
extern MemoryUsagePack* memory_usage_pack;
...
extern PageTable* next_kernel_page_table;
extern serial::SerialDevice* com1;
#endif